defmodule Stormstout.Import.Stage do
  @moduledoc """
  ...
  alias Ecto.Multi
  alias Stormstout.Explorer.Import.Runner

  @typedoc """
  Maps `t:Stormstout.Import.Import.Runner.t/0` callback module to the `t:Stormstout.Import.Import.Runner.changes_list/0` it
  can import.
  """
  ...
  @doc """
  Uses a single `t:Stormstout.Import.Runner.t/0` and chunks the `changes_list` across multiple `t:Ecto.Multi.t/0`
  """
