defmodule StormstoutWeb.ProfileLive do
  @moduledoc false
  ...
  alias Stormstout.{Explorer, AptosRPC}
  alias StormstoutWeb.ProfileLive.{NFTComponent, OfferComponent}
  ...
  # defp get_wallet_tokens(account), do: Stormstout.Explorer.list_account_tokens(account)
end
