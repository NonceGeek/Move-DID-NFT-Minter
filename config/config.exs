...
config :stormstout,
  ecto_repos: [Stormstout.Repo]

# Configures the endpoint
config :stormstout, StormstoutWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: StormstoutWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Stormstout.PubSub,
...
config :stormstout, Stormstout.Mailer, adapter: Swoosh.Adapters.Local
...
# config/config.exs
config :stormstout, Oban,
  repo: Stormstout.Repo,
